...
for i in range(1, 11):
    ...
    if i == 9:
        ...
        ActionChains(driver).move_to_element(staff).perform()
        driver.find_element(By.XPATH, '//*[@id="pane-first"]/div/div[2]/div[2]/div' + [i].__str__() +
                            '/div' + [week_time].__str__() + '/div[2]/div/button[2]/span').click()
        time.sleep(3)
...
for i in range(1, 11):
    ...
    time.sleep(5)
    try:
        driver.find_element(By.XPATH, '/html/body/div[2]/div[1]/div[1]//ul/li//span[text()="4人"]').click()
        print('预约人数失败', i)
    except:
        a = driver.find_element(By.XPATH, '//*[@x-placement="bottom-start"]//span[text()="4人"]')
    ...
    if i == 9:
        ...
        driver.find_element(By.XPATH, '//*[@id="pane-second"]/div/div[2]/div[2]/div' + [i].__str__() +
                            '/div' + [week_time].__str__() + '/div[2]/div/button[2]/span').click()
        time.sleep(5)
        # driver.find_element(By.XPATH, '/html/body/div[2]/div/div[3]/span/button[1]').click()
